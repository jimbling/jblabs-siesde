...
@section('content')
    <div class="container-fluid">
                    ...
                    <div class="card-body">
                        <div class="row gy-3">
                            <div class="col-12 col-sm d-flex flex-column">
                                <h3 class="h2">Selamat datang, {{ $user->name ?? 'Guest' }}!</h3>
                                <p class="text-muted mb-2">
                                    Anda sedang menggunakan <strong>SIESDE</strong> — Sistem Informasi Elektronik Sekolah
                                    Digital yang membantu pencatatan <strong>buku induk peserta didik</strong> secara
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                ...
                                <div class="text-muted">
                                    {{ $stats['new_this_month'] }} peserta didik
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                ...
                                <div class="text-muted">
                                    {{ $stats['special_needs'] }} peserta didik
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                ...
                                <div class="text-muted">
                                    {{ $stats['scholarship'] }} peserta didik
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row row-deck row-cards mb-4">
            <!-- Kolom Kiri: 2 Card secara vertikal -->
            <div class="col-lg-4 d-flex flex-column">
                ...
                <div class="card flex-fill mb-4">
                    ...
                    <div class="card-body">
                        @if ($rombelStats->count())
                            <div class="table-responsive">
                                <table class="table table-sm table-bordered table-striped table-compact">
                        ...
                        @else
                            <div class="text-muted">Tidak ada data peserta didik aktif.</div>
                        @endif
                    </div>
                </div>
            ...
            <!-- Kolom Kanan: 1 Card penuh -->
            <div class="col-lg-8">
                <div class="card h-100">
                    <div class="card-header">
                        <h3 class="card-title">Top 5 Kelurahan Asal Peserta Didik</h3>
                    </div>
                    <div class="card-body">
                        <div id="top-kelurahan-chart" style="height: 100%; min-height: 350px;"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Modal: Daftar Siswa Belum Lengkap Dokumen -->
        <div class="modal fade" id="incompleteDocsModal" tabindex="-1" aria-labelledby="incompleteDocsModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header bg-danger text-white">
                        <h5 class="modal-title" id="incompleteDocsModalLabel">
                            ...
                            Daftar Peserta Didik Belum Lengkap Dokumen
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                    </div>
                    <div class="modal-body p-3">
                        @if ($studentsIncompleteDocs->isEmpty())
                            <div class="text-center text-muted py-4">
                                Semua peserta didik telah melengkapi dokumen wajib.
                            </div>
                        @else
                            <div class="table-responsive">
                                <table class="table table-sm table-bordered table-hover align-middle">
                                    <thead class="table-danger">
                                        <tr>
                                            ...
                                            <th>Nama</th>
                                            <th>Kelas</th>
                                            <th>Dokumen Belum Ada</th>
                                            <th>Aksi</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($studentsIncompleteDocs as $index => $student)
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
                                                ...
                                                <td>{{ $student['kelas'] }}</td>
                                                <td>
                                                    @foreach ($student['missing_docs'] as $doc)
    ...
    @push('scripts')
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                const genderData = @json($stats['gender_distribution']);

                const categories = Object.keys(genderData).map(key => {
                    return key === 'L' ? 'Laki-laki' : key === 'P' ? 'Perempuan' : key;
                });
                ...
                const options = {
                    ...
                    plotOptions: {
                        bar: {
                            horizontal: true,
                            borderRadius: 4,
                            distributed: true, // warna berbeda per kategori
                            dataLabels: {
                                position: 'top'
                            }
                        }
                    ...
                    colors: ['#206bc4', '#f76707', '#37b24d', '#fa5252'], // bisa tambah jika lebih dari 2
                    legend: {
                        show: false
                    }
                };
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                const kelurahanData = @json($stats['top_kelurahan']);

                const seriesData = kelurahanData.map(item => item.total);
                const labelData = kelurahanData.map(item => item.kelurahan);

                const topKelurahanChart = new ApexCharts(document.querySelector("#top-kelurahan-chart"), {
                    chart: {
                        type: 'bar',
                        height: 300,
                        toolbar: {
                    ...
                    colors: ['#206bc4', '#2fb344', '#f76707', '#fa5252', '#7048e8'],
                    tooltip: {
                        y: {
