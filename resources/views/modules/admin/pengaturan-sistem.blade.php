                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="provinsi"
                                        value="{{ $setting->provinsi }}" disabled>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="kode_pos"
                                        value="{{ $setting->kode_pos }}" disabled>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="website"
                                        value="{{ $setting->website }}" disabled>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-column gap-3">
                                            ...
                                            <div class="d-flex gap-2">
                                                <label class="btn btn-primary btn-sm flex-grow-1"
                                                ...
                                                @else
                                                    <div class="border-2 border-dashed rounded d-flex flex-column align-items-center justify-content-center text-center p-3"
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                            <path
                                                                d="M3 3h4v4h-4zM17 3h4v4h-4zM3 17h4v4h-4zM17 17h4v4h-4z" />
                                            ...
                                            <div class="d-flex gap-2">
                                                <label class="btn btn-primary btn-sm flex-grow-1"
                                                    ...
                                                    <input type="file" name="qrcode_logo" class="visually-hidden"
                                                        accept="image/*"
                                                        onchange="previewImage(event, 'qrcodeLogoPreview')">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        class="icon icon-tabler icon-tabler-upload" width="16"
                                                        height="16" viewBox="0 0 24 24" stroke-width="2"
                                                        stroke="currentColor" fill="none" stroke-linecap="round"
                                                ...
                                                @if ($setting->favicon)
                                                    <div class="position-relative text-center">
                                                        <img id="faviconPreview"
                                                            ...
                                                            alt="Favicon" class="img-fluid rounded"
