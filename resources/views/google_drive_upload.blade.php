            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @else
                        ...
                        <div class="empty">
                            <div class="empty-img">
                                <img src="{{ asset('static/illustrations/google-drive.svg') }}" height="128"
                                    alt="">
                            </div>
                                    ...
                                    <ol class="steps steps-vertical">
                                        ...
                                        <li class="step-item">
                                            ...
                                            <div class="step-content">
                                                ...
                                                <p class="step-text text-muted">Anda akan kembali ke halaman Login sistem.
                                                    Silahkan login lagi dan pada halaman ini akan muncul akun yang berhasil
                                                    terhubung</p>
                                            </div>
                                        </li>
                                    </ol>
